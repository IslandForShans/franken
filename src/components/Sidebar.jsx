...
export default function Sidebar({
  ...
  const toggleAllCategories = () => {
    ...
    const collapsedCount = allCategories.filter((cat) =>
  ...
  if (
    ...
    const hasItems =
      (availableComponents.factions &&
        availableComponents.factions.length > 0) ||
      (availableComponents.blue_tiles &&
        availableComponents.blue_tiles.length > 0) ||
      (availableComponents.red_tiles &&
        availableComponents.red_tiles.length > 0);
          ...
          {availableComponents.factions &&
            availableComponents.factions.length > 0 && (
              <div key="factions-section" className="mb-4">
                <div
                  className="sidebar-category-header text-sm font-bold mb-2 text-purple-400"
          ...
          {availableComponents.blue_tiles &&
            availableComponents.blue_tiles.length > 0 && (
              <div key="blue-tiles-section" className="mb-4">
                <div
                  className="sidebar-category-header text-sm font-bold mb-2 text-blue-400"
                  style={{ paddingLeft: "0.75rem" }}
                >
                  ...
                  {availableComponents.blue_tiles.map((tile, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-2 font-medium">
                        <span>{tile.name}</span>
                        {Array.isArray(tile.planets) &&
                          tile.planets.flatMap((planet, pIdx) => {
                            const traitIcons = Array.isArray(planet.trait_icons)
                              ...
                              : [];
                            const techIcons = Array.isArray(
                              planet.tech_specialty_icons,
                            )
                              ? planet.tech_specialty_icons.map(
                                  (icon, iIdx) => (
                                    <img
                                      key={`tech-${pIdx}-${iIdx}`}
                                      src={icon}
                        ...
                        {tile.wormhole_icon && (
                          <img
                            src={tile.wormhole_icon}
                            alt="wormhole"
                            className="w-4 h-4"
                          />
                        )}
                        {Array.isArray(tile.anomaly_icons) &&
                          tile.anomaly_icons.map((icon, i) => (
                            <img
                              key={`anomaly-${i}`}
                              src={icon}
                              alt="anomaly"
                        ...
                        {Array.isArray(tile.planets) &&
                          tile.planets.some((p) => p.legendary_icon) && (
                            <img
                              src={
                                tile.planets.find((p) => p.legendary_icon)
                                  ?.legendary_icon
                              }
                              alt="legendary"
          ...
          {availableComponents.red_tiles &&
            availableComponents.red_tiles.length > 0 && (
              <div key="red-tiles-section">
                <div
                  className="sidebar-category-header text-sm font-bold mb-2 text-red-400"
                  style={{ paddingLeft: "0.75rem" }}
                >
            ...
            >
              ...
              {hoveredComponent.category === "factions" &&
                (() => {
                  ...
                  let fullFaction = factionsData.factions.find(
                      ...
                      <div className="sidebar-item-row">
                        ...
                        <div className="sidebar-item-content">
                          <div className="flex items-center gap-2 font-medium flex-wrap">
                            ...
                            {cat === "commodity_values" &&
                              component.description !== undefined && (
                                <span
                                  className="ml-auto text-sm font-bold opacity-40"
                                  style={{ color: "#fcd34d" }}
                                >
                            ...
                            {(cat === "red_tiles" || cat === "blue_tiles") &&
                              ...
                              component.planets.flatMap((planet, pIdx) => {
                                const traitIcons = Array.isArray(
                                  planet.trait_icons,
                                )
                                  ? planet.trait_icons.map((icon, iIdx) => (
                                      <img
                            ...
                            {(cat === "red_tiles" || cat === "blue_tiles") &&
                              Array.isArray(component.planets) &&
                              component.planets.some(
                                (p) => p.legendary_icon,
                              ) && (
                                <img
                                  src={
                                    component.planets.find(
                                      (p) => p.legendary_icon,
                                    )?.legendary_icon
                                  }
                                  alt="legendary"
                            ...
                            <>
                              ...
                              {cat === "starting_techs" &&
                                ...
                                component.techs.map((t, i) => {
                                  ...
                                  const color =
                                    techColorMap[t.tech_type] || "#fff";
                                  return (
                                    <div
                                      key={i}
                                      className="text-xs"
                                      style={{ color, marginBottom: "0.15rem" }}
                                    >
                              ...
                              {Array.isArray(component.abilities) &&
            ...
            {hoveredComponent.category === "factions" && (
              <div className="mt-2">
                ...
                <p className="text-sm text-gray-300 italic">
                  During the build phase, you'll be able to select components
                  from this faction to build your custom faction.
                </p>
              </div>
            )}
  ...
  return noWrapper ? (
    ...
    <div className={`sidebar${isOpen !== false ? " open" : ""}`}>{content}</div>
  );
}
