      ...
      {role === "host" && (
        <div className="space-y-4">
          <div className="text-xs text-gray-400">
            Generate an offer code for each player, share it with them, then
            paste back their answer code.
          </div>
          {guestSlots.map((slotId, i) => {
            ...
            return (
              <div
                key={slotId}
                className="space-y-2 p-3 bg-gray-900 rounded-lg border border-gray-700"
              >
                  ...
                  <>
                    <div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() =>
                            copy(offerCodes[slotId], `offer_${slotId}`)
                          }
      ...
      {role !== "host" && (
        <div className="space-y-3">
          {phase !== "connected" ? (
            <>
              <div className="text-xs text-gray-400">
                Paste the offer code from the host:
              </div>
              <textarea
                value={offerInput}
