      ...
      <div className="space-y-8">
        {factions.map((f, i) => {
          ...
          return (
            <div
              key={i}
              className="bg-gray-800 rounded-xl p-4 border border-gray-700 shadow mb-4"
            >
              ...
              <div className="mb-3 p-4 bg-gray-900 rounded-lg text-white font-mono">
                <strong className="text-base block mb-3 font-sans text-yellow-300">
                ...
                {resourceCalc.assignment.length > 0 && (
                  <div className="mt-4 pt-3 border-t border-gray-700">
                    <div className="font-sans font-medium text-xs mb-2 text-gray-300">
                      Planet Assignments:
                    </div>
                    <div className="grid grid-cols-3 gap-2 text-xs font-sans">
                      ...
                      <div>
                        ...
                        {resourceCalc.assignment
                          ...
                          .map((a, idx) => (
                            <div key={idx} className="text-gray-300">
                              {a.planet.name} ({a.planet.resource}/
                              {a.planet.influence})
                            </div>
                          ))}
                      </div>
                    ...
                    <li key={idx} className="mb-2">
                      ...
                      {tile.planets &&
                        tile.planets.map((p) => (
                          <div
                            key={p.name}
                            className="ml-4 text-xs text-white flex flex-wrap items-center gap-1 mb-0.5"
                          >
                            ...
                            {p.legendary_ability && (
                              <img
                                src={ICON_MAP.legendary}
                                alt="legendary"
                                title={p.legendary_ability}
              ...
              {/* Other Components */}
              {Object.keys(f)
                .filter((c) => !["name", "blue_tiles", "red_tiles"].includes(c))
                .map((cat) => {
                  const items = f[cat] || [];
