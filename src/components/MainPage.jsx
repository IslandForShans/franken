      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-blue-500 transition-all hover:shadow-xl hover:shadow-blue-900/30">
            ...
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-blue-400">
              Draft Simulator
            </h4>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-purple-500 transition-all hover:shadow-xl hover:shadow-purple-900/30">
            <div className="text-4xl mb-4">🔧</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-purple-400">
              Faction Builder
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-green-500 transition-all hover:shadow-xl hover:shadow-green-900/30">
            <div className="text-4xl mb-4">🌌</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-green-400">
              Expansion Support
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
              Toggle support for official and fan expansions. Mix and match
              content to suit your playgroup.
            </p>
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-red-500 transition-all hover:shadow-xl hover:shadow-red-900/30">
            <div className="text-4xl mb-4">🚫</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-red-400">
              Ban Management
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-yellow-500 transition-all hover:shadow-xl hover:shadow-yellow-900/30">
            <div className="text-4xl mb-4">📊</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-yellow-400">
              Resource Analysis
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-cyan-500 transition-all hover:shadow-xl hover:shadow-cyan-900/30">
            <div className="text-4xl mb-4">🔄</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-cyan-400">
              Smart Swaps
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-teal-500 transition-all hover:shadow-xl hover:shadow-teal-900/30">
            <div className="text-4xl mb-4">📖</div>
            <h4 className="text-xl sm:text-2xl font-bold mb-3 text-teal-400">
              Component Reference
            </h4>
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
              Browse every component from every faction. Search, filter by
              category, and view by faction or component type.
            </p>
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 sm:p-8 border border-gray-700 hover:border-orange-500 transition-all hover:shadow-xl hover:shadow-orange-900/30">
            ...
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
              Drag and drop tiles onto a standard 3-ring hex grid to design your
              game map.
            </p>
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start">
      ...
      <footer className="border-t border-gray-700 bg-gray-900 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400">
          <p className="text-sm sm:text-base">
            TI4 Franken Draft Simulator - Community tool for Twilight Imperium
            4th Edition
          </p>
          <p className="text-xs sm:text-sm mt-2">
            Disclaimer: This tool is an unofficial fan project and is not
            affiliated with, endorsed by, or approved by Fantasy Flight Games or
            Asmodee. All game content, including faction names, component names,
            artwork references, and other intellectual property, belongs to
            Fantasy Flight Games and Asmodee. This project exists purely as a
            fan resource for the Twilight Imperium community and is not intended
            for commercial use. This site may be taken down at any time upon
            request from Fantasy Flight Games, Asmodee, or any of their
            representatives. If you are a rights holder and would like this
            content removed, please contact sendit2isaiah@gmail.com.
          </p>
        </div>
      </footer>
    </div>
